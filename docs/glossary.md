...
Explorers contribute by submitting Observations, completing Scout Tasks and helping improve the Atlas.
...
A community contributor who helps expand and maintain the Atlas through real-world exploration.

Scouts contribute observations and evidence.

They do not directly edit Canonical Knowledge.

## Scout Task

An opportunity generated by the Atlas requesting additional evidence.

Scout Tasks direct community effort towards areas where the Atlas would most benefit from improved knowledge.
...
Trust influences community responsibilities and promotion recommendations.
